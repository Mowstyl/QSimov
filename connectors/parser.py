...
__rep__ = re.compile("^([a-zA-Z0-9]+)(\((?:(?:(?:[a-zA-Z]+)|(?:[0-9]+(?:\.[0-9]+)?))\,\s*)*(?:(?:(?:[a-zA-Z]+)|(?:[0-9]+(?:\.[0-9]+)?)))\))?(\-1)?$")
...
__gateDict__["deutsch"] = ("Deutsch", 1, 1)
__gateDict__["xx"] = ("XX", 1, 1)
__gateDict__["isingx"] = ("XX", 1, 1)
__gateDict__["isingxx"] = ("XX", 1, 1)
__gateDict__["yy"] = ("YY", 1, 1)
__gateDict__["isingy"] = ("YY", 1, 1)
__gateDict__["isingyy"] = ("YY", 1, 1)
__gateDict__["zz"] = ("ZZ", 1, 1)
__gateDict__["isingz"] = ("ZZ", 1, 1)
__gateDict__["isingzz"] = ("ZZ", 1, 1)
